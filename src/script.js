...
let skyState = 0 // For monitoring what type of sky it is
const earthShades = ['200, 200, 25, .5', '255, 255, 25, .5', '150, 150, 25, .5', '50, 50, 25, .5', '100, 100, 25, .5'] // For changing the shadow on the earth with the sky

// Sets the sky to be the size of the window, minus space for the earth
function skyHeight () {
	let skyHeight = $(window).height() - $('.earth').height()
